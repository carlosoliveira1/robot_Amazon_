...
Caso de teste 01 - Acesso ao menu "Eletrônicos"
    [Documentation]     Esse teste verifica o menu eletronicos da Amazon.com.br
...
Caso de teste 02 - Pesquisa de um Produto
    [Documentation]    Esse teste varifica a busca de um produto
...
Caso de Teste 03 - Adicionar Produto no Carrinho
    ...
    Quando ele digita o nome do produto "Xbox Series S" no campo de pesquisa
    E clica no botão de pesquisa
    Então o resultado da pesquisa deve listar o produto "Console Xbox Series S"
    Quando ele adiciona o produto "Console Xbox Series S" ao carrinho
